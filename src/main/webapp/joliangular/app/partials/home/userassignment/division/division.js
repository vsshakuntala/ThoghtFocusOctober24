...
divisionmodule.controller('DivisionController',
    ['$scope',
        ...
        function ($scope, $rootScope, $log, $compile, $state, $stateParams, DTOptionsBuilder,
            ...
            onLoadTasks();
            $scope.assignedSelectedDivisionList={};
            $scope.unassignedSelectedDivisionList={};
            $scope.assignedSelectedDivision = [];
            ...
            // }
             $scope.checkToggleAssigned = function (assignedCheck) {
                ...
                $scope.assignedSelectedDivisionList.divisions={};
                 //$scope.assignedgrplist = [];
                  if ($('.selectallcheckboxassigndivision').prop("checked") == true) {
                        $log.debug("selectallcheckboxassigndivision is checked.");
                        $scope.assignedSelectedDivisionList.divisions = angular.copy($scope.assignedDivision);
                        $log.debug("SelectedAssignedRole :"+angular.toJson($scope.assignedSelectedDivisionList.divisions));
                    }
            ...
            // }
             $scope.checkToggleUnAssigned = function (unAssignedCheck) {
               ...
               $scope.unassignedSelectedDivisionList.divisions = {};
                
               if ($('.selectallcheckboxunassigndivision').prop("checked") == true) {
                        $log.debug("selectallcheckboxunassigndivision is checked.");
                        $scope.unassignedSelectedDivisionList.divisions = angular.copy($scope.unAssignedDivision);
                        $log.debug("SelectedAssignedRole :"+angular.toJson($scope.unassignedSelectedDivisionList.divisions));
                    }
            }
            ...
            $scope.moveToAssigned = function (unassignedSelectedDivision) {
                $scope.unassignedSelectedDivisionList={};
                $log.debug("moved to assigned :"+unassignedSelectedDivision)
                ...
                $('.selectallcheckboxunassigndivision').attr('checked', false);
            }
            $scope.moveToUnAssigned = function (assignedSelectedDivision) {
                ...
                assignedSelectedDivision = [];
                 $('.selectallcheckboxassigndivision').attr('checked', false);
            }
