            ...
            */
            $scope.getUser = function () {
                genericService.getObjectById($rootScope.baseUrl + 'usermgmtrest/getuser/' + $scope.userDetails.userId + '/' + $rootScope.adminId).then(function (response) {
                    ...
                    console.log("getting user email from server "+$scope.userEmail);
            ...
            $scope.submitUpdateForm = function (user) {
                if ($scope.user.userLanguage) {
                    ...
                    if(angular.equals($scope.userEmail,$scope.user.email)){                    	
                    	 console.log("user inside if "+angular.toJson(user));
                             genericService.putObject($rootScope.baseUrl + 'usermgmtrest/updateuser', user).
                    	 ...
                    	 console.log("user inside elese "+angular.toJson(user));
                    	 genericService.getObjects($rootScope.baseUrl + 'usermgmtrest/checkemailexistance?email=' + $scope.user.email)
                         .then(function (response) {
                             $rootScope.stopSpin();
                             $rootScope.startSpin();
                             genericService.putObject($rootScope.baseUrl + 'usermgmtrest/updateuser', user).
