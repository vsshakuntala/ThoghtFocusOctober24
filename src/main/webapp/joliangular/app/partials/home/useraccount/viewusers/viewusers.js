    ...
    ['$scope',
        ...
        function ($scope, $state, $rootScope, $log, $compile, $filter, divisionList, DTOptionsBuilder,
            ...
            $scope.drawDataTable = function () {
                ...
                $log.debug("outside filter!!!! :"+angular.toJson($rootScope.filteredObjectsCopyInDivision));
                $log.debug(($scope.filteredObjects.name != '' || $scope.filteredObjects.companyName != ''));
                $log.debug(!angular.equals($rootScope.filteredObjectsCopyInDivision, null))
